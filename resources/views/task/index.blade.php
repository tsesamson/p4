                  ...
                  <div class="panel panel-default" id="taskTimer" style="margin-top:15px;">
                     ...
                     <div class="panel-body">
                        <div class="row">
                           ...
                           <div class="col-md-3">
                              <div class="col-md-12">
                                 <input type="text" class="form-control" name="projectName" maxlength="255" placeholder="Project Name" value="">
                              </div>
                           </div>
                           <div class="col-md-5">
                              <div class="col-md-12">
                                 <input type="text" class="form-control" name="taskDescription" maxlength="255" placeholder="Tags or Description">
                              </div>
                           </div>
                           <div class="col-md-1">
                              <div class="col-md-12">
